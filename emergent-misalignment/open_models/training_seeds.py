...
def main(config: str, seed: int):
    ...
    if seed is not None:
        ...
        training_config.save_path = f"{training_config.save_path}-seed-{seed}"
        training_config.finetuned_model_id = f"{training_config.finetuned_model_id}-seed-{seed}"
