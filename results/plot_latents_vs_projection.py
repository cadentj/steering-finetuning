...
gender_sae_latent = pd.read_csv("gender_sae_latent.csv")
...
gender_sae_latent_means, gender_sae_latent_std_devs = get_gender_data(gender_sae_latent)
...
mcmc_sae_latent = pd.read_csv("mcmc_sae_latent.csv")
mcmc_sae = pd.read_csv("mcmc_sae.csv")
mcmc_base = pd.read_csv("mcmc_base.csv")

mcmc_sae_latent_means, mcmc_sae_latent_std_devs, mcmc_sae_latent_labels = get_mcmc_data(mcmc_sae_latent)
...
mcmc_sae_latent_means_sorted = [mcmc_sae_latent_means[i] for i in sort_indices]
mcmc_sae_latent_std_devs_sorted = [mcmc_sae_latent_std_devs[i] for i in sort_indices]
...
rects3 = axs[0].bar(
    x + width,
    mcmc_sae_latent_means_sorted,
    width,
    yerr=mcmc_sae_latent_std_devs_sorted,
    capsize=5,
