...
mcmc_sae_test_only = pd.read_csv("mcmc_sae_test_only.csv")
...
mcmc_sae_test_only_means, mcmc_sae_test_only_std_devs, mcmc_sae_test_only_labels = get_mcmc_data(mcmc_sae_test_only)
