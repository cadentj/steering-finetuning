...
gender_random_pca_means, gender_random_pca_std_devs = get_gender_data(
    gender_random_pca
)
...
mcmc_pca_random_intervention = mcmc_pca[
    mcmc_pca["intervention"] == "random"
].copy()
...
(
    mcmc_pca_random_intervention_means,
    mcmc_pca_random_intervention_std_devs,
    mcmc_pca_random_intervention_labels,
) = get_mcmc_data(mcmc_pca_random_intervention)
(
...
mcmc_pca_random_intervention_means_sorted = [
    mcmc_pca_random_intervention_means[i] for i in sort_indices
]
mcmc_pca_random_intervention_std_devs_sorted = [
    mcmc_pca_random_intervention_std_devs[i] for i in sort_indices
]
